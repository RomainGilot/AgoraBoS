...
/* accueil.html.twig */
class __TwigTemplate_960dfbfeb1561110ee7d0db8c04b2e8c extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 15
        echo "         Bonjour ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "session", [], "any", false, false, false, 15), "get", [0 => "prenomUtilisateur"], "method", false, false, false, 15), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "session", [], "any", false, false, false, 15), "get", [0 => "nomUtilisateur"], "method", false, false, false, 15), "html", null, true);
        echo "
      </div>
   </div>
</div>
...
";
    ...
    {
        return array (  80 => 15,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{#       Bonjour <?php  echo \$_SESSION[\"prenomUtilisateur\"].' '.\$_SESSION[\"nomUtilisateur\"] ; ?>#}
         Bonjour {{ app.session.get('prenomUtilisateur') }} {{ app.session.get('nomUtilisateur') }}
      </div>
   </div>
</div>

{% endblock %}
", "accueil.html.twig", "/Applications/MAMP/htdocs/École/Symfony/AgoraBoS2/templates/accueil.html.twig");
    }
}
